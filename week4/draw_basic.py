...
def main():
    window = make_canvas(500, 300)
    window.create_line(0, 0, 500, 300, width =8, fill='blue')
    window.create_text(0, 0, text='Test', font='times 90', fill='greenyellow', anchor=tk.NW)
    tk.mainloop()
